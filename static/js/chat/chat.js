document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupEventListeners() {
        ...
        // New chat modal
        if (newChatBtn) {
            console.log('newChatBtn found, adding click event listener');
            newChatBtn.addEventListener('click', openNewChatModal);
        } else {
            console.error('newChatBtn element not found!');
        }
        
        if (modalClose) {
            console.log('modalClose found, adding click event listener');
    ...
    function closeNewChatModal() {
        ...
        if (newChatModal) {
            console.log('Modal element found, removing show class');
